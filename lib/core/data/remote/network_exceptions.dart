...
class NetworkExceptions with _$NetworkExceptions {
  ...
  static Future<ApiResult<T>> handleError<T>(e) async {
    try {
      if (e is DioError &&
        ...
        if (error is DioError) {
          switch (error.type) {
            ...
            case DioErrorType.unknown:
              networkExceptions = NetworkExceptions.handleResponse(error.response?.statusCode);
              break;
            ...
            case DioErrorType.badResponse:
              networkExceptions = const NetworkExceptions.defaultError('Bad response');
              break;
