...
class AppToast {
  ...
  static void success(String message, {Color? color, Toast? length }) {
  ...
  static void error(String message, {Color? color, double? opacity, Toast? length}) {
    Fluttertoast.showToast(
        msg: message,
        toastLength: length??Toast.LENGTH_LONG,
        gravity: ToastGravity.CENTER,
  ...
  static void warning(String message, {Color? color,Toast? length}) {
    Fluttertoast.showToast(
        msg: message,
        toastLength: length??Toast.LENGTH_LONG,
        gravity: ToastGravity.CENTER,
